...
* CWL Tools are regenerated by [`make_compliant.sh`](https://github.com/fairagro/M4.4_UC6_ARC/blob/c84d842e7c7f741f4549bef9841271273d212f6c/workflows/make_compliant.sh) which moves alle files to the folder structure needed for validation
```bash
#! /bin/bash
